...
//    if (t_1 - t_start < 3000) {
//      pwm = 255;
//    } else if (t_1 - t_start < 5000) {
//      pwm = 200;
//    } else if (t_1 - t_start < 7000) {
//      pwm = 120;
//    } else if (t_1 - t_start < 9000) {
//      pwm = 140;
//    } else if (t_1 - t_start < 10000) {
//      pwm = 130;
//    }else if (t_1 - t_start < 12000) {
//      pwm = 200;
//    }else if (t_1 - t_start < 14000) {
//      pwm = 180;
//    }else if (t_1 - t_start < 16000) {
//      pwm = 250;
//    }else if (t_1 - t_start < 16000) {
//      pwm = 230;
//    }else if (t_1 - t_start < 18000) {
//      pwm = 150;
//    }else if (t_1 - t_start < 20000) {
//      pwm = 230;
//    }
